...
var $PDFVersion; 
 protected $B = 0;
    protected $I = 0;
    protected $U = 0;
    protected $HREF = '';        // PDF version number
/*******************************************************************************
*                                                                              *
*                               Public methods                                 *
*                                                                              *
...
function Header()
{
$this->Image('../../pdf/logo.jpg',15,7,60);
// $this->Ln(40);
...
// Titre
// $this->Cell(190,10,$this->societe['raisonsocial'],0,0,'L',0);
// $this->Line(0,21.5,70,21);
//  $this->Line(0,21.5,70,22);
//$this->Line(70,21,85,12);
//  $this->Line(70,22,85,13);
//  $this->Line(85,12,210,12);
//  $this->Line(85,13,210,13);
/*    $this->Line(70,1,85,12);
$this->Line(70,2,85,13);*/
/*    $this->Line(85,12,210,12);
$this->Line(85,13,210,13);*/
$this->Ln(20);
/*  $this->SetFont('Arial','',10);
$this->Cell(45);
$this->Cell(100,10,'CABINET VETERINAIRE',0,1);
$this->Image('logoar.jpg',140,6);
$this->Cell(40);
$this->SetFont('Arial','u',07.95);
$this->Cell(100,10,'C  O  N  S  E  I  L      E  N      P  R  O  D  U  C  T  I  O  N  S     A  V  I  C  O  L  E  S       I  N  T  E  N  S  I  V  E  S',0,1);
$this->SetFont('Arial','',07.95);
$this->Cell(100,10,'Suivi et Encadrement Sanitaires des Unités Avicoles – Diagnostic des Pathologies des Volailles – Analyse de l’eau &agrave;','C',0,1);
...
if (isset($_GET['si'])) {
	$this->Image('../../pdf/signe.png',160,240,35);
}
...
$this->Cell(30,5,$this->societe['raisonsocial'],0,0,'R',0);
$this->SetFont('deja',' ',8);
$this->Cell(190,5,' , ' .$this->societe['adresse'] . ' - Email : '. $this->societe['email'] ,0,1,'L');
$this->MultiCell(190,5,'Téle : ' .$this->societe['telephone'].'  - Fax :  ' .$this->societe['fax'].
	' - I.F : ' .$this->societe['iff'].'  - R.C :  ' .$this->societe['rc'].'  -  patente : '. $this->societe['patente']
	);

$this->SetX(75);
$this->Cell(190,5,' N° compte :  '.$this->societe['compte'] ,0,1,'L');
...
function tFPDF($orientation='P', $unit='mm', $size='A4')
{
	...
	// Initialization of properties
		$societe=new societe();
		$this->societe=$societe->selectById(1);
	$this->page = 0;
	$this->n = 2;
	$this->buffer = '';
	$this->pages = array();
