...
$result=connexion::getConnexion()->query("select v.bon_commande, v.remarque as obj,c.*,v.date_vente,v.id_user, u.nom AS nom_user
...
$pdf->Cell(50, 5, 'FACTURE PROFORMA', 0, 0, 'C', 0, 0);
...
$pdf->SetFont('dejavusans', '', 9, '', true);
$pdf->Cell(40,8,'Facture PF N°      : PF.' . $vente1["id_vente"] . ' - ' . $str,0,1,'L',0);
...
$pdf->SetFont('dejavusans', '', 9, '', true);
$pdf->Cell(40,8,'Validité de l\'offre : ' . $vente1["validite"],0,1,'L',0);
...
$pdf->SetFont($font, '', 9, 'I', true);
$pdf->Cell(13,8,'',0,0,'L',0);
$pdf->SetFont($font_light, '', 9, 'I', true);
$pdf->Cell(170,8,'',0,1,'L',0);
$pdf->Ln(2);
$cont=0;
...
<table cellspacing="0" cellpadding="3" border="1" class="mytable">
 <tr style="background-color:#a5a2a2; color:white !important;">
       <th  align="center" height="10" width="10%" style="color:white; font-weight:800; font-size:8.3pt;">Référence</th>
        <th  align="center" height="10" width="50%" style="color:white; font-weight:800; font-size:8.3pt;">DÉSIGNATION</th>
...
$pdf->writeHTML("<p>Arréter la présente facture proforma a la somme de :</p>", true, false, false, false, '');
