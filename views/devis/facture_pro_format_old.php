...
$data2=connexion::getConnexion()->query("SELECT r.mode_reg,dv.unit, dv.valunit,p.code_bar,p.tva,p.unite,p.designation,p.poid,dv.prix_produit,p.poid,dv.qte_vendu,dv.remise,dv.id_vente 
...
$pdf->Cell(50,5,'PRO-FORMAT' ,1,1,'C',1,0);
...
$cont=0;
$pdf->SetFont('dejavusans', '', 9, '', true);
$pdf->Cell(80,10,'Facture N° : PF.'.$vente1["id_vente"] .' - ' . $str,0,1,'L',0);
$pdf->SetFont('dejavusans', '', 9, '', true);
...
$pdf->writeHTML("<p>Arréter le présente pro-format a la somme de :</p>", true, false, false, false, '');
