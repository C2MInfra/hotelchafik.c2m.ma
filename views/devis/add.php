        ...
        <div class="col align-self-start">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mb-4">Ajouter Un Nouveau Devis</h5>
                    ...
                    <form id="addform" method="post" name="form_produit" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                          ...
                          <div class="form-row">
                            ...
                            <div class="form-group col-md-10" id="bon">
    						...
    						<div class="form-group">
                                ...
                                <select name="bon_commande" id="bon_commande" class="form-control select2-single">
                                	...
                                	<?php foreach($listbon as $bon): ?>
                                	     <option value="<?php echo $bon->id_bon ?>">
                                	     	<?php echo $bon->id_bon . ' ' . $bon->remarque ?>
                                	     </option>
                                	<?php endforeach; ?>
                                </select>
                            </div>
		     ...
		     //add product
                ...
                $.ajax({
                    ...
                    success: function (data) {
						...
						toastr.success("Nouveau produit a été bien ajouté");
             ...
             $.ajax({
                ...
                if (data.indexOf("success")>=0) {
                    ...
                    $.ajax({
                              ...
                              url: `<?php echo BASE_URL."views/devis/index.php"?>`,
