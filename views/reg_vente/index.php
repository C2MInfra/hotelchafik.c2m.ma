...
$id = explode('?id=',$_SERVER["REQUEST_URI"])[1];
 ...
 select c.* from client c,vente v 
 where v.id_client=c.id_client
 and v.id_vente=".$id
 )->fetch(PDO::FETCH_ASSOC);
//  var_dump( $infos['nom']);die();
 $total=0;
...
<div class="container-fluid disable-text-selection">
    <div class="row">
        ...
        <div class="col-12">
            <div class="mb-2">
                <h1>Nouveau reglement d'vente N° <?php echo $id ?></h1>
                <div class="float-sm-right text-zero">
                    <button type="button" class="btn btn-primary btn-lg  mr-1 url notlink" data-url="reg_vente/add.php?id=<?php echo $id ?>" >AJOUTER</button>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 mb-4">
            <div class="card h-100">
                <div class="card-body">
                     <h5 class="mb-2">Reglement d'vente N&deg; <?php echo $id; ?>  Total est: <?php echo number_format($total,2,'.',' ') ; ?> Dh </h5>
