...
$pdf->Cell(50,5,'Bon Sortie' ,0,0,'C',0,0);
...
$pdf->SetFont('dejavusans', '', 9, '', true);
$pdf->Cell(40,8,'BS N°                   : BS00' . $vente1["numbon"] .' - '.  $str,0,1,'L',0);
...
<table cellspacing="0" cellpadding="3" border="1" class="mytable">
 <tr style="background-color:#a5a2a2; color:white !important;">
        <th  align="center" height="10" width="20%" style="color:white;">Référence</th>
        <th  align="center" height="10" width="60%" style="color:white;">Désignation</th>
        <th  align="center" height="10" width="20%" style="color:white;">Quantité</th>
