<?php
	...
	$data = $vente->selectallbond(date('Y') . '-' . date('m'), 1);
?>
  ...
  <div class="row">
    ...
    <div class="col-12">
      ...
      <div class="mb-2">
        ...
        <h1>Liste Des Bons Livraison</h1>
    ...
    <div class="col-xl-12 col-lg-12 mb-4">
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <form method="get" name="frm" id="formfilterbon">

            <input type="hidden" name="act" value="filterbon">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-2">
                <button  type="button" class="btn btn-primary default btn-lg btn-block  mr-1 factAll" style="margin-top: 30px;">Facturer</button>
              </div>
            </div>
                  ...
                  <td class="nowrap">
                   ...
                   if(!empty($ligne->motunitv) || $ligne->motunitv!=0){
                    ...
                    <td class="nowrap" style="text-align: right;"> <?php
                      ...
                      if(!empty($ligne->motunitv) || $ligne->motunitv!=0){
                        echo number_format($ligne->motunitv - $paye, 2, '.', ' ');
                      }else{
                    ...
                    <td class="nowrap">
                      ...
                      <a class="badge badge-info mb-2  " style="color: white;cursor: pointer;" title="Imprimer Bon de sortie" href="<?php echo BASE_URL."views/vente/bon_sortie.php?id=".$ligne->id_vente; ?>&h=15"  target="_black" >
...
// var myinitvalu=0;
t=[];
 $('.multyFact').change(function(){
    cmpar=$(this).parent().find('.slecli').val();
    t= $(".multyFact:checked").map(function(){
      return $(this).parent().find('.slecli').val();
    }).get();
    console.log(t);
    for(i=0;i<t.length;i++){
      if(t[i]!=cmpar){
        $('.multyFact').prop("checked",false)
      }
    }
 });
 ...
 //filter-------------------------------------
  $("#formfilterbon").on("submit", function(event) {
  ...
  <script>
  $('.factAll').click(function(){
    if($('.multyFact').is(':checked')){
     t= $(".multyFact:checked").map(function(){
      return $(this).val();
    }).get();
      
    window.location.href ='/facture/add.php?idv[]='+t;
