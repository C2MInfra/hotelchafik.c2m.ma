...
<table cellspacing="0" cellpadding="3" border="1" class="mytable">
 ...
 <th  align="center" colspan="2"  width="30%" style="color:white; font-weight:800; font-size:8.5pt;">Date</th>
      <th  align="center"  width="15%"  rowspan="2" style="color:white; font-weight:800; font-size:8.5pt;">Numero chambre</th>
      <th  align="center" colspan="2"  width="20%" style="color:white; font-weight:800; font-size:8.5pt;">Nombre</th>
     
      <th  align="center"  width="15%" rowspan="2" style=" color:white; font-weight:800; font-size:8.5pt;">P U</th>
      <th  align="center"  width="20%" rowspan="2" style="color:white; font-weight:800; font-size:8.5pt;">TOTAL</th>
    </tr>
   <tr align="center" style="background-color:#2597d5;color:white; font-weight:800; font-size:8.5pt;  ">
   <th width="15%">Entrée</th>
   <th width="15%">Sortie</th>
   <th width="10%">Personnes</th>
...
<table cellspacing="0" cellpadding="6"   class="tab-foot" width="100%">
    <tr>
	  <td width="60%">
       ...
       <th border="1" align="left"  width="20%" style="background-color:#2597d5; color:white;">Total TTC</th>
	  <td align="right" border="1" width="20%">' . number_format($total *1.1, 2, ".", " ") . '</td>
    </tr>
    <tr>
	  <td width="60%">
	  </td>
       <th border="1" align="left"  width="20%" style="background-color:#2597d5; color:white;">Total HT </th>
	  <td align="right" border="1" width="20%">' . number_format($total, 2, ".", " ") . '</td>
    </tr> 
     <tr>
	  <td width="60%">
	  </td>
       <th border="1" align="left"  width="20%" style="background-color:#2597d5; color:white;">TVA 10% </th>
	  <td align="right" border="1" width="20%">' . number_format($total * 0.1, 2, ".", " ") . '</td>
    </tr>   
     <tr>
	   <td width="60%">
	   </td>
