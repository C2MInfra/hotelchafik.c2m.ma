...
$oldvalue=$avoir->selectById($id[1]);
...
<div class="row">
  ...
  <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="mb-4">Modification avoir</h5>

                          <form id="addform" method="post" name="form_avoir" enctype="multipart/form-data">
