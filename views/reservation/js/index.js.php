        ...
        },
        {
          "render": function(data, type, row, meta) {
            ...
            ?>
              ...
              html += `<a class="badge badge-warning mr-2 mb-2" target="blank" href="<?php echo BASE_URL . 'views/detail_reservation'; ?>/facture.php?id=${row.id_reservation}" style="color: white;cursor: pointer;" title="Imprimer" href="javascript:void(0)">
