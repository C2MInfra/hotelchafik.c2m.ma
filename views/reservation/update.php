          ...
          <form id="addform" method="post" name="form_produit" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <select class="form-control select2-single" name="id_client" id="clients">
                  ...
                  foreach ($clients as $key => $value) {
                    ...
                    $option =  "<option value=\"$value->id_client\" $selected>$value->nom</option>";
                    echo $option;
                  }
                  ?>
                </select>
              ...
              <div class="form-group col-md-6">
                ...
                <input type="date" class="form-control" id="date_reservation" name="date_reservation" value="<?php echo $reservation['date_reservation']; ?>">
              </div>
            </div>
            <div class="form-row" style="align-items:center;">
              <div class="form-group col-md-12">
                <label for="remarque"> Remarque : </label>
                <textarea class="form-control" name="remarque" id="remarque"><?php echo $reservation['remarque']; ?></textarea>
              </div>
            </div>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-2">
                <button id="update-reservation-detail" type="button" class="pull-right btn btn-success default btn-lg btn-block mr-1 " style="margin-top: 31px;">Ajouter</button>
              </div>
            </div>
