...
<div class="container-fluid disable-text-selection">
    <div class="row">
        <div class="col-12">
            <div class="mb-2">
                <h1>Nouveau reglement d'avoir N° <?php echo $id ?></h1>
                ...
                <div class="float-sm-right text-zero">
                    <button type="button" class="btn btn-primary btn-lg  mr-1 url notlink" data-url="reg_avoir/add.php?id=<?php echo $id ?>" >AJOUTER</button>
                </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 mb-4">
            <div class="card h-100">
                <div class="card-body">
                     <h5 class="mb-2">Reglement d'avoir N&deg; <?php echo $id; ?>  Total est: <?php echo number_format($total,2,'.',' ') ; ?> Dh </h5>
 ...
 $('#datatables').dataTable({
            ...
            {
                extend: 'excel',
                title:"reglement avoir N° : <?php echo $id ?>",
                exportOptions: {
                     columns: [ 0, 1, 2,3,4,5 ]
                }
            },
