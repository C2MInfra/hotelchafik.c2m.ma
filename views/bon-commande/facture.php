...
$pdf->setXY(140, 10);
//$pdf->write1DBarcode('BC.' . $boncommande1["id_bon"], 'C128B', '', '', '', 22, 3, $style1d, 'T');
...
$pdf->Cell(50, 5, 'Order Fabrication Interne', 0, 0, 'C', 0, 0);
...
$pdf->SetFont('dejavusans', '', 9, '', true);
$pdf->Cell(40,8,'Date                    : ' . date('d/m/Y',strtotime($boncommande1["date_bon"])),0,1,'L',0);
#second Row
$pdf->SetFont('dejavusans', '', 9, '', true);
...
$pdf->SetFont('dejavusans', '', 9, '', true);
$pdf->Cell(40,8,'BC N°              : BC.' . $boncommande1["id_bon"],0,1,'L',0);
...
<table cellspacing="0" cellpadding="3" border="1" class="mytable">
 <tr style="background-color:#a5a2a2; color:white !important;">
        ...
        <th  align="center" height="10" width="70%" style="color:white; font-weight:800; font-size:8.3pt;">DÉSIGNATION</th>
...
$pdf->writeHTML("Arréter le présent bon commande a la somme de :", true, false, false, false, '');
...
$pdf->writeHTML("<p>" . $boncommande1['remarque'] . "</p>", true, false, false, false, '');
$pdf->SetFont('dejavusans', 'B', 7, '', true);

$div = '<table>
            <tr>
                <td align="center">Représentant</td>
                <td align="center">Producteur</td>
            </tr>
      </table>';
      $pdf->ln(10);
