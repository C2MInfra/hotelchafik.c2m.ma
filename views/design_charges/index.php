...
include('../../evr.php');
 ...
 $design=new design();
 $data=$design->selectAll();
?>
<div class="container-fluid disable-text-selection">
  <div class="row">
    <div class="col-12">
      <div class="mb-2">
        <h1>Liste des design</h1>
        <div class="float-sm-right text-zero">
          <button type="button" class="btn btn-primary btn-lg  mr-1 url notlink" data-url="design_charges/add.php" >AJOUTER</button>
        </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a class="badge badge-warning mb-2  url notlink" data-url="design_charges/update.php?id=<?php echo $ligne->id; ?>" style="color: white;cursor: pointer;" title="Modifier"
           ...
           $('#datatables').dataTable({
            ...
            $('body').on( "click",".delete", function( event ) {
             event.preventDefault();
                ...
                swal({
                 title: 'Êtes-vous sûr?',
                  text: "Voulez vous vraiment Supprimer ce design !",
                  type: 'warning',
