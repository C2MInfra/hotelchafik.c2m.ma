...
$oldvalue=$detail_avoir->selectById($id[1]);
...
<div class="row">
  ...
  <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="mb-4">Modification detail_avoir</h5>

                          <form id="addform" method="post" name="form_detail_avoir" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    $("#addform" ).on( "submit", function( event ) {
             ...
             $.ajax({
                ...
                success: function (data) {
                if (data=="success") {
                    form.append(` <div id="alert-success" class="alert  alert-success alert-dismissible fade show rounded mb-0" role="alert"> <strong>detail_avoir bient Modifie</strong> <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button> </div>`);
                }
                else{
