          ...
          <form id="addform" method="post" name="form_Client" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                ...
                <select name="type_compte" class="form-control type_compte" data-style="btn-white"
                  ...
                  <option value="0" <?php echo ($oldvalue['type_compte'] == 0) ? "selected" : '' ?>>
                    Client (Marocaine)</option>
                  <option value="1" <?php echo ($oldvalue['type_compte'] == 1) ? "selected" : '' ?>>
                    Client (Ètrangère)</option>
                  <option value="2" <?php echo ($oldvalue['type_compte'] == 2) ? "selected" : '' ?>>
                    Société (Marocaine)</option>
                  <option value="3" <?php echo ($oldvalue['type_compte'] == 3) ? "selected" : '' ?>>
                    Société (Ètrangère)</option>
                </select>
              </div>
              ...
              <!-- <div class="form-group col-md-4 societe">
                ...
                <input type="text" class="form-control" id="nom" name="nom"
                  value="<?php echo $oldvalue['nom'] . ' ' . $oldvalue['prenom']; ?>">
              </div> -->
            </div>
            <div class="form-row mb-3">
              <div class="col-md-12 " id="veriv"
                style=" box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25);overflow: hidden; margin: 0 auto; max-width: 836px; display: none;">
                <iframe src="https://ice.marocfacture.com/"
                  style=" overflow: scroll; border: 0px none; height: 809px;  width: 100%; margin-top: -150px">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4 client">
                ...
                <input type="text" class="form-control" value="<?php echo $oldvalue['passport']; ?>" id="passport"
                  name="passport">
              </div>
              <div class="form-group col-md-4 client">
                <label for="carte_sejour"> Carte sejour :</label>
                <input type="text" class="form-control" value="<?php echo $oldvalue['carte_sejour']; ?>"
                  id="carte_sejour" name="carte_sejour">
              </div>
              <div class="form-group col-md-4">
                <label for="telephone">T&eacute;l&eacute;phone :</label>
                <input type="text" class="form-control" value="<?php echo $oldvalue['telephone']; ?>" id="telephone"
                  name="telephone">
              </div>
              <div class="form-group col-md-4">
                <label for="email">Email : </label>
                <input type="text" class="form-control" value="<?php echo $oldvalue['email']; ?>" id="email"
                  name="email">
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <select name="id_nationalite" id="nationalite" class="form-control select2-single">
                  ...
                  foreach ($nationalite as $key => $value) {
                    $selected = '';
                    if ($oldvalue['id_nationalite'] == $value['id_nationalite']) {
                      $selected = 'selected';
                    }
              ...
              <div class="form-group col-md-4">
                ...
                <select name="id_pays" id="pays" class="form-control select2-single">
                  ...
                  foreach ($pays as $key => $value) {
                    $selected = '';
                    if ($oldvalue['id_pays'] == $value['id_pays']) {
                      $selected = 'selected';
                    }
                ...
                <div class="input-group">
                  ...
                  <div class="custom-file">
                    ...
                    <input type="text" class="form-control" id="plafond" name="plafond"
                      value="<?php echo $oldvalue['plafond'] ?>">
