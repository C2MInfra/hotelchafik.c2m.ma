...
<div class="container-fluid disable-text-selection">
 ...
 <input type="hidden" id="id_bon" value="<?php echo $id  ?>"/>
        ...
        <div class="float-sm-right text-zero">
          <button type="button" class="btn btn-primary btn-lg  mr-1 url notlink" data-url="detail_commande/add.php?id=<?php echo $id ?>" >AJOUTER</button>
        </div>
              ...
              <tbody>
                ...
                <tr id="<?php echo $ligne->id_detail; ?>">
                  ...
                  <td>
                    ...
                    value="<?php echo $ligne->qte_vendu; ?>"/>
                    <span
