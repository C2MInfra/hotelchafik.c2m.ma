...
elseif ($_POST['act']=='delete') 
{
	try {
			$detail_commande = new detail_commande();
			$dv = $detail_commande->selectById($_POST['id']);

			$detail_commande->delete($_POST["id"]);
...
elseif ($_POST['act']=='update_detail') 
{
	...
	$dv = $detail_commande->selectById($_POST['id_detail']);


	$rs = $detail_commande->update($_POST['id_detail']);
	
	$totales = $detail_commande->gettotale($_POST['id_bon']);
