        ...
        <div class="col-12">
            <div class="mb-2">
                ...
                <div class="float-sm-right text-zero">
                    <button type="button" class="btn btn-success  url notlink" data-url="detail_commande/index.php?id=<?php echo $id ?>" > <i class="glyph-icon simple-icon-arrow-left"></i></button>
                </div>
            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3" >
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <input type="text" name="unit" id="unite" class="form-control ml-3" placeholder="Kg ou M²...">
    ...
    $( document ).ready(function() {
        ...
        $("input.datepicker").datepicker({
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo BASE_URL.'views/detail_commande/' ;?>controle.php",
                data: {act:"insert",id_produit: $("#id_produit").val() ,prix_produit: $("#prix_produit").val(), 
                ...
                success: function (data) {
                   if (data=="success") {
                    ...
                    $.ajax({
                              ...
                              method:'POST',
                              data: {ajax:true},
                              url: `<?php echo BASE_URL."views/detail_commande/index.php?id=".$id;?>`,
                              context: document.body,
                              success: function(data) { 
                                      history.pushState({},"",`<?php echo BASE_URL."detail_commande/index.php?id=".$id;?>` );
                                      $("#main").html( data );
                                }
                            });
                    });
