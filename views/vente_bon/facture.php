...
$pdf->Cell(13,8,'DOUNIAPLAST',0,0,'L',0);
$pdf->SetFont($font_light, '', 9, 'I', true);
$pdf->Cell(170,8,'vous remercie de votre demande et vous envoi ci après notre meilleure offre :',0,1,'L',0);
$pdf->Ln(2);
$cont=0;
...
<table cellspacing="0" cellpadding="3" border="1" class="mytable">
 <tr style="background-color:#a5a2a2; color:white !important;">
       <th  align="center" height="10" width="10%" style="color:white; font-weight:800; font-size:8.3pt;">Référence</th>
        <th  align="center" height="10" width="42%" style="color:white; font-weight:800; font-size:8.3pt;">DÉSIGNATION</th>
        <th  align="center" height="10" width="10%" style="color:white; font-weight:800; font-size:8.3pt;">QUANTITÉ</th>
        <th  align="center" height="10" width="8%" style="color:white; font-weight:800; font-size:8.3pt;">UNITÉ</th>
