...
$infos=connexion::getConnexion()->query("
 select c.* from fournisseur c,achat a 
...
<div class="container-fluid disable-text-selection">
    ...
    <div class="row">
        <div class="col-12">
            <div class="mb-2">
                <h1>Nouveau reglement d'achat N° <?php echo $id ?></h1>
                <div class="float-sm-right text-zero">
                    <button type="button" class="btn btn-primary btn-lg  mr-1 url notlink" data-url="reg_achat/add.php?id=<?php echo $id ?>" >AJOUTER</button>
                </div>
             </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 mb-4">
            ...
            {
                extend: 'excel',
                title:"reglement Achat N° : <?php echo $id ?> \n"+nom+"\n"+ice+"\n"+adresse,
                exportOptions: {
                     columns: [ 0, 1, 2,3,4,5 ]
                }
            },
