...
<div class="row">
        <div class="col-12">
            <div class="mb-2">
                <h1>Nouveau reglement achat N&deg; : <?php echo $id ?>  </h1>
                 <div class="float-sm-right text-zero">
                    <button type="button" class="btn btn-success  url notlink" data-url="reg_achat/index.php?id=<?php echo $id ?>" > <i class="glyph-icon simple-icon-arrow-left"></i></button>
                </div>
               </div>
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <p><strong> doit payer : </strong>
                    ...
                    <form id="addform" method="post" name="form_reg_achat" enctype="multipart/form-data">
...
//            }
            if (errors != "") {
             ...
             $.ajax({
                type: "POST",
                url: "<?php echo BASE_URL.'views/reg_achat/' ;?>controle.php",
                ...
                if (data.indexOf("success")>=0) {
                    swal(
                      'Ajouter',
                      'reglement achat a ete bien Ajouter',
                      'success'
                    ).then((result) => {
                    $.ajax({
                              method:'POST',
                              data: {ajax:true},
                              url: `<?php echo BASE_URL."views/reg_achat/index.php?id=".$id;?>`,
                              context: document.body,
                              success: function(data) { 
                                      history.pushState({},"",`<?php echo BASE_URL."reg_achat/index.php?id=".$id;?>` );
                                      $("#main").html( data );
                                }
                            });
                    });
