...
<div class="container-fluid disable-text-selection">
    <div class="row">
        <div class="col-12">
            <div class="mb-2">
                <h1>Etat Des Ventes Par Categorie</h1>
					...
					<div class="col-xl-12 col-lg-12 mb-4">
						<div class="card mb-4">
							<div class="card-body" id="etat">
								<h3 class="mb-4" >  Etat Des Ventes Par Categorie  <span id="spanyear" class="badge badge-pill badge-primary mb-1"><i class="glyph-icon simple-icon-clock"></i> <?php echo $year?></span> </h3>
