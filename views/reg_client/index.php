...
<div class="container-fluid disable-text-selection">
    <div class="row">
        <div class="col-12">
            <div class="mb-2">
                ...
                <h1>reglement Client N° <?php echo $id ?> : <?php echo $client["nom"]." ".$client["prenom"] ?>   <span id="total_reste" val="<?php echo $montant_a_paye?>" class="badge badge-pill badge-danger mb-1" style="font-size:10pt;"> <?php echo number_format($montant_a_paye, 2, ".", " "); ?> DH</span> </h1>
                <div class="float-sm-right text-zero">
                    <button type="button" class="btn btn-primary btn-lg  mr-1 url notlink" data-url="reg_client/add.php?id=<?php echo $id ?>" >AJOUTER</button>
                </div>
 ...
 $('#datatables').dataTable({
            ...
            {
                extend: 'excel',
                title:"reglement Client N° <?php echo $id ?> : <?php echo $client["nom"]." ".$client["prenom"] ?>",
                exportOptions: {
                     columns: [ 0, 1, 2,3,4,5 ]
                }
            },
