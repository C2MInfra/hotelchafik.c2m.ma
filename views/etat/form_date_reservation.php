...
">
 ...
 <fieldset class="tableform" style="width: 400px;padding: 30px; background-color:#ddd; border-radius:6px; margin:20px auto !important;">
<form method="post"  action="<?php echo BASE_URL?>/views/etat/etat_reservation.php" name="form_date" >
