<?php
class reg_reservation extends table {
   protected $id_reg;
   ...
   public function selectAll2($id) {
      $result = connexion::getConnexion()->query("select * from reg_reservation where id_reservation=" . $id . "  order by id_reg  desc ");
      return $result->fetchAll(PDO::FETCH_OBJ);
   }
   public function selectAll3_er($date) {
      $result = connexion::getConnexion()->query("select rga.* from reg_reservation rga
...
dif from reg_reservation ra,reservation a,fournisseur f where ra.id_reservation=a.id_reservation 
