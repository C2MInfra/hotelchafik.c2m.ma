...
class serial_code {
   ...
   public static function selectMaxSerial() {
      $result = connexion::getConnexion()->query("select code from serial_code where id=0  ");
      return $result->fetch(PDO::FETCH_OBJ);
   }

   public static function selectCode() {
      $result = connexion::getConnexion()->query("select valeur_key from societe where id=1  ");
      return $result->fetch(PDO::FETCH_OBJ);
   }
