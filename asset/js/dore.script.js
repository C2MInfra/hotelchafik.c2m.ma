        ...
        if (void 0 !== oe) {
            ...
            if ($("#inputImage").length > 0) {
                ...
                le.onchange = function() {
                    var e, t = this.files;
                    t && t.length && (e = t[0], $("#cropperContainer").css("display", "block"), /^image\/\w+/.test(e.type) ? (uploadedImageType = e.type, uploadedImageName = e.name, de.src = uploadedImageURL = URL.createObjectURL(e), se && se.destroy(), se = new oe(de, re), le.value = null) : window.alert("Please choose an image file."))
                }
            }
        }
