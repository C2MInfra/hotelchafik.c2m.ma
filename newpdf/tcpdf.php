...
//
// Description :
//   This is a PHP class for generating PDF documents without requiring extlogoernal extensions.
//
// NOTE:
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$image_file = '../../asset/img/logo_pdf.png';
    	//$this->writeHTMLCell(170, 120, '', '', $image_file);
        $this->Image($image_file, 12, 10, 60, 28, 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
		//$this->Image($image_file, 10, 10, 70, 34, 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
		// Set font
	...
	public function Footer() 
	{
		...
		$this->SetY(-15);
//		if (isset($_GET['si'])) {
//			$this->Image('img/signe.png',160,240,35);
//		}
		$html = "
		<style type='text/css'>
		    h4{
		...
		<div>
		     <table border='0'>
			     <tr>
				    <td align='right'>
					   <b>" . $this->societe['raisonsocial'] . "</b>
					   <br>
					   " . $this->societe['adresse'] . "
					   <br>
					</td>
					<td style='border-right:1px solid black;'>
					      Tel  : " . $this->societe['telephone'] . "<br>
					</td>
					<td>
					   Patente : " . $this->societe['patente'] . "<br>
					   RC      :  " . $this->societe['rc'] . "    -  IF :  " . $this->societe['iff'] . " <br>
					   ICE     : " . $this->societe['ice'] . "
					</td>
				 </tr>
			 </table>
		</div>
		...
		$this->Cell(190,5, $this->societe['raisonsocial'] . ' , ' .$this->societe['adresse'] . '  Tel: ' . $this->societe['telephone'] ,0,1,'C');

        $this->Cell(190,5,'CNSS: 8017867     -     ICE: ' . $this->societe['patente'] . '      -     IF: '. $this->societe['iff'] . '     -     RC: ' . $this->societe['rc'], 0, 1, 'C');
		*/
		...
		// $this->Cell(26, 22, $this->getAliasNumPage().' / '.$this->getAliasNbPages(), 0, false, 'C', 0, '', 0, false, 'T', 'M');
	}
