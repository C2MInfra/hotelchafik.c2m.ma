...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$image_file = K_PATH_IMAGES.'img/log1o.jpg';


		$this->Image($image_file, 10, 0, 180, 30, 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
		// Set font
	...
	public function Footer() 
	{
        ...
        $this->Cell(190,5,'CNSS: 2568626     -     ICE: ' . $this->societe['patente'] . '      -     IF: '. $this->societe['iff'] . '     -     RC: ' . $this->societe['rc'], 0, 1, 'C');
